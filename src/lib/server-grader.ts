        ...
        messages: [
          {
            role: 'system',
            content:
              '你是数学作业批改助手。请根据题目、参考答案和学生作答（可能包含手写图片），严格返回 JSON：{"score": 0到100的整数, "isCorrect": 是否判对, "feedback": "简短中文评语"}。请仔细识别图片中的手写内容与公式。如果图片模糊、空白、无法辨认，请返回 feedback 为「图片不清晰，请重新拍照上传」；只有在确实看清图片内容、且与题目完全无关时，才提示作答与题目无关。不要返回其他内容。',
          },
          {
            role: 'user',
            content: [
