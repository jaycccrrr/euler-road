(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,63059,471,x=>{"use strict";var e=x.i(46349);x.s(["ChevronRight",()=>e.default],63059);let d=(0,x.i(75254).default)("arrow-left",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]);x.s(["ArrowLeft",()=>d],471)},31573,x=>{"use strict";var e=x.i(43476),d=x.i(22016),t=x.i(71645),a=x.i(3374),s=x.i(95907),i=x.i(15288),r=x.i(19455),l=x.i(87486),c=x.i(77572),o=x.i(76639),y=x.i(88968),n=x.i(10980),b=x.i(20278),f=x.i(63059);let p=(0,x.i(75254).default)("file-text",[["path",{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z",key:"1oefj6"}],["path",{d:"M14 2v5a1 1 0 0 0 1 1h5",key:"wfsgrz"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);var m=x.i(32095),h=x.i(471),u=x.i(83086),z=x.i(37727);function g({module:x,moduleId:g}){let[v,j]=(0,t.useState)(x),[N,k]=(0,t.useState)(null),[D,C]=(0,t.useState)(!1);(0,t.useEffect)(()=>{if(!v&&g){let x=s.KNOWLEDGE_MODULES.find(x=>x.id===g);x&&j(x)}},[v,g]);let P=x=>{k(x),C(!0)};return v?(0,e.jsxs)("div",{className:"min-h-screen",children:[(0,e.jsx)(a.default,{}),(0,e.jsxs)("main",{className:"container mx-auto px-4 py-8",children:[(0,e.jsx)(d.default,{href:"/",children:(0,e.jsxs)(r.Button,{variant:"ghost",className:"mb-4",children:[(0,e.jsx)(h.ArrowLeft,{className:"w-4 h-4 mr-2"}),"返回首页"]})}),(0,e.jsxs)("div",{className:`relative overflow-hidden rounded-3xl bg-gradient-to-br ${v.color} p-8 md:p-12 mb-8`,children:[(0,e.jsx)("div",{className:"absolute inset-0 bg-pattern-dots opacity-20"}),(0,e.jsxs)("div",{className:"relative z-10 flex flex-col md:flex-row items-center gap-6",children:[(0,e.jsx)("div",{className:"w-24 h-24 bg-white/20 rounded-2xl flex items-center justify-center text-5xl backdrop-blur-sm",children:v.icon}),(0,e.jsxs)("div",{className:"text-center md:text-left text-white",children:[(0,e.jsx)(l.Badge,{className:"bg-white/20 text-white mb-2",children:"math"===v.category?"数学":"physics"===v.category?"物理":"计算机"}),(0,e.jsx)("h1",{className:"text-3xl md:text-4xl font-bold mb-2",children:v.name}),(0,e.jsx)("p",{className:"text-white/90 max-w-xl",children:v.description})]})]})]}),(0,e.jsxs)(c.Tabs,{defaultValue:"advanced",className:"space-y-6",children:[(0,e.jsxs)(c.TabsList,{className:"grid w-full grid-cols-2",children:[(0,e.jsxs)(c.TabsTrigger,{value:"advanced",className:"flex items-center gap-2",children:[(0,e.jsx)(b.Target,{className:"w-4 h-4"}),"提高篇"]}),(0,e.jsxs)(c.TabsTrigger,{value:"basic",className:"flex items-center gap-2",children:[(0,e.jsx)(n.BookOpen,{className:"w-4 h-4"}),"基础篇"]})]}),(0,e.jsx)(c.TabsContent,{value:"advanced",children:(0,e.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:v.topics.map(x=>(0,e.jsx)(i.Card,{className:"p-6 cartoon-card hover:scale-[1.02] transition-transform cursor-pointer group",children:(0,e.jsxs)("div",{className:"flex items-start justify-between",children:[(0,e.jsxs)("div",{className:"flex-1",children:[(0,e.jsxs)("div",{className:"flex items-center gap-2 mb-2",children:[(0,e.jsx)("h3",{className:"text-lg font-bold group-hover:text-purple-600 transition-colors",children:x.title}),(0,e.jsx)(l.Badge,{variant:x.difficulty>3?"destructive":x.difficulty>2?"default":"secondary",children:"★".repeat(x.difficulty)})]}),(0,e.jsx)("p",{className:"text-sm text-gray-500 mb-4",children:"包含常见易错点和经典例题"}),(0,e.jsxs)(r.Button,{variant:"outline",size:"sm",className:"group-hover:bg-purple-50",onClick:()=>P(x),children:["开始学习",(0,e.jsx)(f.ChevronRight,{className:"w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform"})]})]}),(0,e.jsx)("div",{className:"w-12 h-12 bg-gradient-to-br from-purple-100 to-pink-100 rounded-xl flex items-center justify-center",children:(0,e.jsx)(u.Sparkles,{className:"w-6 h-6 text-purple-500"})})]})},x.id))})}),(0,e.jsx)(c.TabsContent,{value:"basic",children:(0,e.jsxs)(i.Card,{className:"p-8 cartoon-card",children:[(0,e.jsxs)("div",{className:"text-center mb-8",children:[(0,e.jsx)("div",{className:"w-16 h-16 bg-gradient-to-br from-blue-100 to-cyan-100 rounded-2xl flex items-center justify-center mx-auto mb-4",children:(0,e.jsx)(m.GraduationCap,{className:"w-8 h-8 text-blue-500"})}),(0,e.jsx)("h2",{className:"text-2xl font-bold mb-2",children:"基础篇教材"}),(0,e.jsxs)("p",{className:"text-gray-500",children:["系统学习",v.name,"的基础知识"]})]}),(0,e.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:v.topics.map((x,d)=>(0,e.jsxs)("div",{className:"flex items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-purple-50 transition-colors cursor-pointer group",onClick:()=>P(x),children:[(0,e.jsx)("div",{className:"w-10 h-10 bg-white rounded-lg flex items-center justify-center font-bold text-purple-600 shadow-sm",children:d+1}),(0,e.jsxs)("div",{className:"flex-1",children:[(0,e.jsx)("h3",{className:"font-medium group-hover:text-purple-600 transition-colors",children:x.title}),(0,e.jsx)("p",{className:"text-sm text-gray-400",children:"基础概念与公式"})]}),(0,e.jsx)(p,{className:"w-5 h-5 text-gray-400 group-hover:text-purple-500"})]},x.id))}),(0,e.jsxs)("div",{className:"mt-8 p-4 bg-blue-50 rounded-xl",children:[(0,e.jsx)("h3",{className:"font-bold text-blue-700 mb-2",children:"推荐学习路径"}),(0,e.jsxs)("ol",{className:"list-decimal list-inside space-y-2 text-sm text-blue-600",children:[(0,e.jsx)("li",{children:"按顺序阅读基础教材"}),(0,e.jsx)("li",{children:"完成每个章节的练习题"}),(0,e.jsx)("li",{children:"进入提高篇挑战难题"}),(0,e.jsx)("li",{children:"参与每日一题巩固知识"})]})]})]})})]}),(0,e.jsx)(o.Dialog,{open:D,onOpenChange:C,children:(0,e.jsxs)(o.DialogContent,{className:"max-w-3xl max-h-[80vh] overflow-y-auto",children:[(0,e.jsxs)(o.DialogHeader,{children:[(0,e.jsxs)(o.DialogTitle,{className:"text-2xl font-bold flex items-center gap-2",children:[(0,e.jsx)(u.Sparkles,{className:"w-6 h-6 text-purple-500"}),N?.title]}),(0,e.jsxs)(o.DialogDescription,{className:"flex items-center gap-2",children:[(0,e.jsx)(l.Badge,{variant:N?.difficulty&&N.difficulty>3?"destructive":N?.difficulty&&N.difficulty>2?"default":"secondary",children:"★".repeat(N?.difficulty||0)}),(0,e.jsx)("span",{className:"text-gray-500",children:"难度等级"})]})]}),(0,e.jsx)("div",{className:"mt-4 prose prose-purple max-w-none",children:N?.content?(0,e.jsx)(y.MathRenderer,{className:"text-gray-700",children:N.content}):(0,e.jsxs)("div",{className:"text-center py-8 text-gray-500",children:[(0,e.jsx)(p,{className:"w-12 h-12 mx-auto mb-3 text-gray-300"}),(0,e.jsx)("p",{children:"该知识点暂无详细内容"})]})}),(0,e.jsx)("div",{className:"mt-6 flex justify-end",children:(0,e.jsxs)(r.Button,{onClick:()=>C(!1),children:[(0,e.jsx)(z.X,{className:"w-4 h-4 mr-2"}),"关闭"]})})]})})]})]}):(0,e.jsxs)("div",{className:"min-h-screen",children:[(0,e.jsx)(a.default,{}),(0,e.jsxs)("main",{className:"container mx-auto px-4 py-12 text-center",children:[(0,e.jsx)("h1",{className:"text-2xl font-bold mb-4",children:"模块未找到"}),(0,e.jsx)(d.default,{href:"/",children:(0,e.jsx)(r.Button,{children:"返回首页"})})]})]})}x.s(["default",()=>g],31573)},78881,x=>{"use strict";var e=x.i(43476),d=x.i(22016),t=x.i(71645),a=x.i(3374),s=x.i(95907);let i={"am-1":[{id:"direction-cosines",title:"方向角与方向余弦",has3D:!0,vizType:"directionCosines",theory:`
## 一、方向角的概念
...
\`\`\`
                ...
                R₀ = β/γ （基本再生数）
  `,examples:[{id:"bio-1",difficulty:"medium",question:"指数增长模型 dN/dt = 0.1N，N(0)=100，求 N(10)。",options:["N(10) = 100·e¹ ≈ 271.8","N(10) = 100·e⁰·¹ ≈ 110.5","N(10) = 100 + 0.1×10 = 101","N(10) = 100·e¹⁰ ≈ 2.2×10⁶"],correct:0,explanation:"dN/dt = rN 的解为 N(t) = N₀e^(rt)\nN(10) = 100·e^(0.1×10) = 100·e¹ ≈ 271.8"},{id:"bio-2",difficulty:"hard",question:"逻辑斯蒂方程 dN/dt = 0.2N(1-N/1000)，N(0)=100，求平衡点。",options:["N = 0 和 N = 1000","N = 100","N = 200","N = 100 和 N = 900"],correct:0,explanation:"令 dN/dt = 0：0.2N(1-N/1000) = 0\n解得 N = 0（不稳定平衡点）或 N = K = 1000（稳定平衡点）"}]}]};var r=x.i(15288),l=x.i(19455),c=x.i(87486),o=x.i(77572),y=x.i(88968),n=x.i(10980),b=x.i(63059),f=x.i(471),p=x.i(83086),m=x.i(21557),h=x.i(75254);let u=(0,h.default)("square-function",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["path",{d:"M9 17c2 0 2.8-1 2.8-2.8V10c0-2 1-3.3 3.2-3",key:"m1af9g"}],["path",{d:"M9 11.2h5.7",key:"3zgcl2"}]]),z=(0,h.default)("menu",[["path",{d:"M4 5h16",key:"1tepv9"}],["path",{d:"M4 12h16",key:"1lakjw"}],["path",{d:"M4 19h16",key:"1djgab"}]]);var g=x.i(37727),v=x.i(69638);let j=(0,h.default)("rotate-ccw",[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]]);var N=x.i(86536);function k({type:x}){let d=(0,t.useRef)(null),[a,s]=(0,t.useState)(0),[i,c]=(0,t.useState)(!0);return(0,t.useEffect)(()=>{var e,t,s,i,r,l,c,o,y,n,b;if(!d.current)return;let f=d.current,p=f.getContext("2d");if(p)switch(f.width=400,f.height=300,p.fillStyle="#ffffff",p.fillRect(0,0,f.width,f.height),x){case"directionCosines":let m,h,u,z,g;e=p,t=f.width,s=f.height,i=a,m=t/2,h=s/2,e.fillStyle="#ffffff",e.fillRect(0,0,t,s),e.strokeStyle="#94a3b8",e.lineWidth=1,e.beginPath(),e.moveTo(m-100,h+50),e.lineTo(m+100,h-50),e.stroke(),e.beginPath(),e.moveTo(m-100,h-30),e.lineTo(m+100,h+70),e.stroke(),e.beginPath(),e.moveTo(m,h-80),e.lineTo(m,h+80),e.stroke(),z=80*Math.cos(u=i*Math.PI/180),g=80*Math.sin(u)*.5,e.strokeStyle="#6366f1",e.lineWidth=3,e.beginPath(),e.moveTo(m,h),e.lineTo(m+z,h-g),e.stroke(),e.fillStyle="#6366f1",e.beginPath(),e.arc(m+z,h-g,5,0,2*Math.PI),e.fill(),e.fillStyle="#475569",e.font="14px sans-serif",e.fillText("x",m+110,h-40),e.fillText("y",m+110,h+80),e.fillText("z",m+10,h-90),e.fillText("a",m+z+10,h-g);break;case"surface":!function(x,e,d,t){let a=e/2,s=d/2;x.fillStyle="#ffffff",x.fillRect(0,0,e,d),x.strokeStyle="#6366f1",x.lineWidth=1;let i=t*Math.PI/180;for(let e=-3;e<=3;e+=.5){x.beginPath();for(let d=-3;d<=3;d+=.1){let t=60*d+a,r=s-(Math.sin(d+i)*Math.cos(e)*30+60*e*.3);-3===d?x.moveTo(t,r):x.lineTo(t,r)}x.stroke()}}(p,f.width,f.height,a);break;case"curve":!function(x,e,d,t){let a=e/2,s=d/2;x.fillStyle="#ffffff",x.fillRect(0,0,e,d),x.strokeStyle="#6366f1",x.lineWidth=2;let i=t*Math.PI/180;x.beginPath();for(let e=0;e<4*Math.PI;e+=.1){let d=a+50*Math.cos(e+i)*(1+e/10),t=s+50*Math.sin(e)*.5;0===e?x.moveTo(d,t):x.lineTo(d,t)}x.stroke()}(p,f.width,f.height,a);break;case"volume":let v,j,N;r=p,l=f.width,c=f.height,o=a,v=l/2,j=c/2,r.fillStyle="#ffffff",r.fillRect(0,0,l,c),N=20*Math.cos(o*Math.PI/180),r.strokeStyle="#6366f1",r.lineWidth=2,r.beginPath(),r.rect(v-60+N,j-60,120,120),r.rect(v-60-N,j-60-20,120,120),r.moveTo(v-60+N,j-60),r.lineTo(v-60-N,j-60-20),r.moveTo(v+60+N,j-60),r.lineTo(v+60-N,j-60-20),r.moveTo(v-60+N,j+60),r.lineTo(v-60-N,j+60-20),r.moveTo(v+60+N,j+60),r.lineTo(v+60-N,j+60-20),r.stroke();break;default:let k,D;y=p,n=f.width,b=f.height,k=n/2,D=b/2,y.fillStyle="#ffffff",y.fillRect(0,0,n,b),y.fillStyle="#e2e8f0",y.fillRect(k-50,D-50,100,100),y.fillStyle="#6366f1",y.font="16px sans-serif",y.textAlign="center",y.fillText("3D 可视化",k,D)}},[x,a]),(0,t.useEffect)(()=>{let x;if(i){let e=()=>{s(x=>(x+.5)%360),x=requestAnimationFrame(e)};x=requestAnimationFrame(e)}return()=>cancelAnimationFrame(x)},[i]),(0,e.jsxs)(r.Card,{className:"p-4 bg-white shadow-sm border-slate-200",children:[(0,e.jsxs)("div",{className:"flex items-center justify-between mb-4",children:[(0,e.jsxs)("h3",{className:"font-semibold text-slate-700 flex items-center gap-2",children:[(0,e.jsx)(N.Eye,{className:"w-4 h-4"}),"3D 可视化"]}),(0,e.jsx)(l.Button,{variant:"outline",size:"sm",onClick:()=>c(!i),children:i?"暂停":"旋转"})]}),(0,e.jsx)("canvas",{ref:d,className:"w-full rounded-lg",style:{maxWidth:"400px",margin:"0 auto",display:"block",background:"#ffffff"}}),(0,e.jsxs)("div",{className:"mt-4 flex gap-2",children:[(0,e.jsx)(l.Button,{variant:"outline",size:"sm",onClick:()=>s(x=>(x-15)%360),children:(0,e.jsx)(j,{className:"w-4 h-4"})}),(0,e.jsx)(l.Button,{variant:"outline",size:"sm",onClick:()=>s(x=>(x+15)%360),children:(0,e.jsx)(j,{className:"w-4 h-4 scale-x-[-1]"})})]})]})}function D({example:x,index:d}){let[a,s]=(0,t.useState)(null),[i,l]=(0,t.useState)(!1),o=a===x.correct;return(0,e.jsxs)(r.Card,{className:"p-6 mb-4 bg-white shadow-sm",children:[(0,e.jsxs)("div",{className:"flex items-center gap-3 mb-4",children:[(0,e.jsx)("span",{className:"w-8 h-8 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center font-semibold text-sm",children:d+1}),(0,e.jsx)(c.Badge,{className:{easy:"bg-green-100 text-green-700",medium:"bg-orange-100 text-orange-700",hard:"bg-red-100 text-red-700"}[x.difficulty],children:{easy:"基础题",medium:"提高题",hard:"挑战题"}[x.difficulty]})]}),(0,e.jsx)("div",{className:"text-slate-800 mb-4 font-medium",children:(0,e.jsx)(y.MathRenderer,{children:x.question})}),(0,e.jsx)("div",{className:"space-y-2 mb-4",children:x.options.map((d,t)=>(0,e.jsxs)("button",{onClick:()=>s(t),className:`w-full text-left p-3 rounded-lg border transition-all ${a===t?t===x.correct?"bg-green-50 border-green-300":"bg-red-50 border-red-300":"bg-slate-50 border-slate-200 hover:border-indigo-300"}`,children:[(0,e.jsxs)("span",{className:"font-medium mr-2",children:[String.fromCharCode(65+t),"."]}),(0,e.jsx)("span",{className:"math-option",children:(0,e.jsx)(y.MathRenderer,{children:d})})]},t))}),null!==a&&(0,e.jsxs)("div",{className:"mt-4",children:[(0,e.jsxs)("div",{className:`p-4 rounded-lg ${o?"bg-green-50":"bg-red-50"}`,children:[(0,e.jsx)("div",{className:"flex items-center gap-2 mb-2",children:o?(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(v.CheckCircle,{className:"w-5 h-5 text-green-500"}),(0,e.jsx)("span",{className:"font-semibold text-green-700",children:"回答正确！"})]}):(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(g.X,{className:"w-5 h-5 text-red-500"}),(0,e.jsx)("span",{className:"font-semibold text-red-700",children:"再试一次"})]})}),!o&&(0,e.jsxs)("p",{className:"text-sm text-slate-600",children:["正确答案是：",String.fromCharCode(65+x.correct)]})]}),(0,e.jsxs)("button",{onClick:()=>l(!i),className:"mt-3 text-indigo-600 hover:text-indigo-700 text-sm font-medium flex items-center gap-1",children:[(0,e.jsx)(n.BookOpen,{className:"w-4 h-4"}),i?"隐藏解析":"查看解析"]}),i&&(0,e.jsxs)("div",{className:"mt-3 p-4 bg-indigo-50 rounded-lg border border-indigo-100",children:[(0,e.jsx)("h4",{className:"font-semibold text-indigo-900 mb-2",children:"解析"}),(0,e.jsx)("div",{className:"text-slate-700 text-sm",children:(0,e.jsx)(y.MathRenderer,{children:x.explanation})})]})]})]})}function C({module:x,moduleId:h}){var v;let[j,C]=(0,t.useState)(x),[P,w]=(0,t.useState)(""),[R,F]=(0,t.useState)("theory"),[T,q]=(0,t.useState)(!0);(0,t.useEffect)(()=>{if(!j&&h){let x=s.KNOWLEDGE_MODULES.find(x=>x.id===h);x&&C(x)}},[j,h]);let L="advanced-math"===(v=h||"")?[...i["am-1"]||[],...i["am-2"]||[],...i["am-3"]||[],...i["am-4"]||[],...i["am-5"]||[],...i["am-6"]||[]]:i[v]||[],S=L.find(x=>x.id===P)||L[0],V=L.findIndex(x=>x.id===P);(0,t.useEffect)(()=>{L.length>0&&!P&&w(L[0].id)},[L,P]);let A=x=>{w(x),F("theory")};return j?(0,e.jsxs)("div",{className:"min-h-screen bg-gradient-to-br from-slate-50 to-slate-100",children:[(0,e.jsx)(a.default,{}),(0,e.jsxs)("div",{className:"flex pt-16",children:[(0,e.jsxs)("aside",{className:`fixed left-0 top-16 bottom-0 bg-white border-r border-slate-200 overflow-y-auto transition-all duration-300 z-40 ${T?"w-80 translate-x-0":"w-80 -translate-x-full"}`,children:[(0,e.jsx)("div",{className:"p-4 border-b border-slate-200",children:(0,e.jsxs)("div",{className:"flex items-center gap-3 mb-4",children:[(0,e.jsx)("div",{className:`w-10 h-10 rounded-lg ${j.color} flex items-center justify-center text-xl`,children:j.icon}),(0,e.jsxs)("div",{children:[(0,e.jsx)("h2",{className:"font-bold text-slate-800",children:j.name}),(0,e.jsxs)("p",{className:"text-xs text-slate-500",children:[L.length," 个课时"]})]})]})}),(0,e.jsxs)("div",{className:"p-4 space-y-2",children:[(0,e.jsxs)("label",{className:"text-xs text-slate-500 font-medium uppercase tracking-wider mb-2 block",children:["课时列表 (",L.length," 个)"]}),(0,e.jsx)("div",{className:"space-y-1 max-h-[calc(100vh-250px)] overflow-y-auto",children:L.map((x,d)=>(0,e.jsx)("button",{onClick:()=>A(x.id),className:`w-full text-left p-3 rounded-lg text-sm transition-all ${P===x.id?"bg-indigo-50 border-l-4 border-indigo-500 text-indigo-700":"hover:bg-slate-50 text-slate-600 border-l-4 border-transparent"}`,children:(0,e.jsxs)("div",{className:"flex items-center gap-2",children:[(0,e.jsx)("span",{className:`w-5 h-5 rounded-full flex items-center justify-center text-xs ${P===x.id?"bg-indigo-500 text-white":"bg-slate-200 text-slate-500"}`,children:d+1}),(0,e.jsx)("span",{className:"font-medium truncate",children:x.title})]})},x.id))})]}),(0,e.jsx)("div",{className:"p-4 border-t border-slate-200",children:(0,e.jsx)(d.default,{href:"/",children:(0,e.jsxs)(l.Button,{variant:"outline",className:"w-full",children:[(0,e.jsx)(f.ArrowLeft,{className:"w-4 h-4 mr-2"}),"返回首页"]})})})]}),(0,e.jsxs)("main",{className:`flex-1 transition-all duration-300 ${T?"ml-80":"ml-0"}`,children:[(0,e.jsx)("button",{onClick:()=>q(!T),className:"fixed left-4 top-20 z-50 p-2 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow",children:T?(0,e.jsx)(g.X,{className:"w-5 h-5"}):(0,e.jsx)(z,{className:"w-5 h-5"})}),(0,e.jsxs)("div",{className:"container mx-auto px-4 py-8 max-w-6xl",children:[(0,e.jsx)("div",{className:"mb-8",children:(0,e.jsxs)("div",{className:"flex items-center gap-3 mb-4",children:[(0,e.jsx)("div",{className:`w-12 h-12 rounded-xl ${j.color} flex items-center justify-center text-2xl`,children:j.icon}),(0,e.jsxs)("div",{className:"flex-1",children:[(0,e.jsxs)("div",{className:"text-sm text-slate-500 mb-1",children:[j.name," · 课时 ",V+1,"/",L.length]}),(0,e.jsx)("h1",{className:"text-3xl font-bold text-slate-800",children:S?.title||"加载中..."}),(0,e.jsxs)("div",{className:"flex items-center gap-3 mt-2",children:[S?.has3D&&(0,e.jsx)(c.Badge,{variant:"outline",className:"bg-blue-50 text-blue-600 border-blue-200",children:"3D可视化"}),S?.examples&&S.examples.length>0&&(0,e.jsxs)(c.Badge,{variant:"outline",className:"bg-green-50 text-green-600 border-green-200",children:[(0,e.jsx)(m.Calculator,{className:"w-3 h-3 mr-1"}),S.examples.length," 道例题"]})]})]})]})}),(0,e.jsxs)(o.Tabs,{value:R,onValueChange:F,children:[(0,e.jsxs)(o.TabsList,{className:"mb-6",children:[(0,e.jsxs)(o.TabsTrigger,{value:"theory",className:"flex items-center gap-2",children:[(0,e.jsx)(n.BookOpen,{className:"w-4 h-4"}),"理论讲解"]}),S?.formula&&(0,e.jsxs)(o.TabsTrigger,{value:"formula",className:"flex items-center gap-2",children:[(0,e.jsx)(u,{className:"w-4 h-4"}),"公式推导"]}),S?.examples&&S.examples.length>0&&(0,e.jsxs)(o.TabsTrigger,{value:"examples",className:"flex items-center gap-2",children:[(0,e.jsx)(m.Calculator,{className:"w-4 h-4"}),"例题练习",(0,e.jsx)(c.Badge,{variant:"secondary",className:"ml-1 text-xs",children:S.examples.length})]}),S?.has3D&&(0,e.jsxs)(o.TabsTrigger,{value:"visualization",className:"flex items-center gap-2",children:[(0,e.jsx)(N.Eye,{className:"w-4 h-4"}),"3D可视化"]})]}),(0,e.jsx)(o.TabsContent,{value:"theory",children:(0,e.jsx)(r.Card,{className:"p-8 bg-white shadow-sm border-slate-200",children:(0,e.jsx)("div",{className:"prose prose-slate max-w-none",children:(0,e.jsx)(y.MathRenderer,{className:"text-slate-700 leading-relaxed",children:S?.theory||"暂无理论内容"})})})}),S?.has3D&&(0,e.jsx)(o.TabsContent,{value:"visualization",children:(0,e.jsxs)(r.Card,{className:"p-8 bg-slate-900 shadow-sm border-slate-800",children:[(0,e.jsxs)("div",{className:"text-center mb-6",children:[(0,e.jsx)(N.Eye,{className:"w-12 h-12 text-indigo-400 mx-auto mb-3"}),(0,e.jsx)("h3",{className:"text-xl font-bold text-white",children:"3D可视化演示"}),(0,e.jsx)("p",{className:"text-slate-400 mt-2",children:"交互式图形帮助理解抽象概念"})]}),(0,e.jsx)("div",{className:"max-w-3xl mx-auto",children:(0,e.jsx)(k,{type:S?.vizType||""})})]})}),(0,e.jsx)(o.TabsContent,{value:"formula",children:(0,e.jsxs)(r.Card,{className:"p-8 bg-gradient-to-br from-indigo-50 to-purple-50 shadow-sm border-indigo-100",children:[(0,e.jsxs)("div",{className:"text-center mb-6",children:[(0,e.jsx)(u,{className:"w-12 h-12 text-indigo-500 mx-auto mb-3"}),(0,e.jsx)("h3",{className:"text-xl font-bold text-slate-800",children:"核心公式与推导"}),(0,e.jsx)("p",{className:"text-slate-500 mt-2",children:"理解公式来源比死记硬背更重要"})]}),S?.formula?(0,e.jsx)("div",{className:"bg-white p-6 rounded-xl shadow-sm",children:(0,e.jsx)(y.MathRenderer,{className:"text-slate-700 leading-relaxed",children:S.formula})}):(0,e.jsx)("div",{className:"bg-white p-6 rounded-xl shadow-sm",children:(0,e.jsx)("p",{className:"text-slate-500 text-center",children:"该课时暂无公式推导内容"})})]})}),(0,e.jsx)(o.TabsContent,{value:"examples",children:(0,e.jsxs)("div",{className:"space-y-4",children:[(0,e.jsxs)("div",{className:"flex items-center justify-between mb-6",children:[(0,e.jsxs)("h3",{className:"text-xl font-bold text-slate-800 flex items-center gap-2",children:[(0,e.jsx)(p.Sparkles,{className:"w-5 h-5 text-yellow-500"}),"精选例题"]}),(0,e.jsxs)("p",{className:"text-sm text-slate-500",children:["共 ",S?.examples?.length||0," 道例题"]})]}),S?.examples&&S.examples.length>0?S.examples.map((x,d)=>(0,e.jsx)(D,{example:x,index:d},x.id)):(0,e.jsxs)(r.Card,{className:"p-8 text-center text-slate-500",children:[(0,e.jsx)(m.Calculator,{className:"w-12 h-12 mx-auto mb-4 opacity-50"}),(0,e.jsx)("p",{children:"该课时暂无例题"})]})]})})]}),(0,e.jsxs)("div",{className:"flex justify-between mt-8",children:[(0,e.jsxs)(l.Button,{variant:"outline",disabled:V<=0,onClick:()=>{V>0&&A(L[V-1].id)},children:[(0,e.jsx)(b.ChevronRight,{className:"w-4 h-4 mr-2 rotate-180"}),"上一课时"]}),(0,e.jsxs)(l.Button,{className:"bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600",disabled:V>=L.length-1,onClick:()=>{V<L.length-1&&A(L[V+1].id)},children:["下一课时",(0,e.jsx)(b.ChevronRight,{className:"w-4 h-4 ml-2"})]})]})]})]})]})]}):(0,e.jsxs)("div",{className:"min-h-screen bg-gradient-to-br from-slate-50 to-slate-100",children:[(0,e.jsx)(a.default,{}),(0,e.jsxs)("main",{className:"container mx-auto px-4 py-12 text-center",children:[(0,e.jsx)("h1",{className:"text-2xl font-bold mb-4",children:"模块未找到"}),(0,e.jsx)(d.default,{href:"/",children:(0,e.jsx)(l.Button,{children:"返回首页"})})]})]})}x.s(["default",()=>C],78881)}]);